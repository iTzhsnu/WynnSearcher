...
public enum SumEnum {
    ...
    TMD_EARTH(earth_Damage(), create_ID_List(Identifications.RAW_EARTH_MELEE_DAMAGE), create_ID_List(Identifications.EARTH_MELEE_DAMAGE_PERCENT, Identifications.EARTH_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT, Identifications.ELEMENTAL_MELEE_DAMAGE_PERCENT), null, true, true, false),
    TMD_THUNDER(thunder_Damage(), create_ID_List(Identifications.RAW_THUNDER_MELEE_DAMAGE), create_ID_List(Identifications.THUNDER_MELEE_DAMAGE_PERCENT, Identifications.THUNDER_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, true, true, false),
    TMD_WATER(water_Damage(), create_ID_List(Identifications.RAW_WATER_MELEE_DAMAGE), create_ID_List(Identifications.WATER_MELEE_DAMAGE_PERCENT, Identifications.WATER_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, true, true, false),
    TMD_FIRE(fire_Damage(), create_ID_List(Identifications.RAW_FIRE_MELEE_DAMAGE), create_ID_List(Identifications.FIRE_MELEE_DAMAGE_PERCENT, Identifications.FIRE_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, true, true, false),
    TMD_AIR(air_Damage(), create_ID_List(Identifications.RAW_AIR_MELEE_DAMAGE), create_ID_List(Identifications.AIR_MELEE_DAMAGE_PERCENT, Identifications.AIR_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, true, true, false),
    ...
    TM_EARTH(earth_Damage(), create_ID_List(Identifications.RAW_EARTH_MELEE_DAMAGE), create_ID_List(Identifications.EARTH_MELEE_DAMAGE_PERCENT, Identifications.EARTH_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, false, false, false),
    TM_THUNDER(thunder_Damage(), create_ID_List(Identifications.RAW_THUNDER_MELEE_DAMAGE), create_ID_List(Identifications.THUNDER_MELEE_DAMAGE_PERCENT, Identifications.THUNDER_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, false, false, false),
    TM_WATER(water_Damage(), create_ID_List(Identifications.RAW_WATER_MELEE_DAMAGE), create_ID_List(Identifications.WATER_MELEE_DAMAGE_PERCENT, Identifications.WATER_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, false, false, false),
    TM_FIRE(fire_Damage(), create_ID_List(Identifications.RAW_FIRE_MELEE_DAMAGE), create_ID_List(Identifications.FIRE_MELEE_DAMAGE_PERCENT, Identifications.FIRE_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, false, false, false),
    TM_AIR(air_Damage(), create_ID_List(Identifications.RAW_AIR_MELEE_DAMAGE), create_ID_List(Identifications.AIR_MELEE_DAMAGE_PERCENT, Identifications.AIR_DAMAGE_PERCENT, Identifications.MELEE_DAMAGE_PERCENT), null, false, false, false),
    TM_SP(null, create_ID_List(Identifications.RAW_MELEE_DAMAGE, Identifications.RAW_ELEMENTAL_MELEE_DAMAGE), null, null, false, false, false),
    ...
    TS_EARTH(earth_Damage(), create_ID_List(Identifications.RAW_EARTH_SPELL_DAMAGE), create_ID_List(Identifications.EARTH_SPELL_DAMAGE_PERCENT, Identifications.EARTH_DAMAGE_PERCENT, Identifications.SPELL_DAMAGE_PERCENT), null, true, false, false),
    TS_THUNDER(thunder_Damage(), create_ID_List(Identifications.RAW_THUNDER_SPELL_DAMAGE), create_ID_List(Identifications.THUNDER_MELEE_DAMAGE_PERCENT, Identifications.THUNDER_DAMAGE_PERCENT, Identifications.SPELL_DAMAGE_PERCENT), null, true, false, false),
    TS_WATER(water_Damage(), create_ID_List(Identifications.RAW_WATER_SPELL_DAMAGE), create_ID_List(Identifications.WATER_MELEE_DAMAGE_PERCENT, Identifications.WATER_DAMAGE_PERCENT, Identifications.SPELL_DAMAGE_PERCENT), null, true, false, false),
    TS_FIRE(fire_Damage(), create_ID_List(Identifications.RAW_FIRE_SPELL_DAMAGE), create_ID_List(Identifications.FIRE_MELEE_DAMAGE_PERCENT, Identifications.FIRE_DAMAGE_PERCENT, Identifications.SPELL_DAMAGE_PERCENT), null, true, false, false),
    TS_AIR(air_Damage(), create_ID_List(Identifications.RAW_AIR_SPELL_DAMAGE), create_ID_List(Identifications.AIR_SPELL_DAMAGE_PERCENT, Identifications.AIR_DAMAGE_PERCENT, Identifications.SPELL_DAMAGE_PERCENT), null, true, false, false),
    TS_SP(create_ID_List(Identifications.RAW_SPELL_DAMAGE, Identifications.RAW_ELEMENTAL_SPELL_DAMAGE), null, null, null, false, false, false),
