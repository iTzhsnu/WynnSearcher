...
public enum Identifications {
    ...
    INGREDIENT_EFFECTIVENESS("", null, "ingEffective", "", "sum", SumEnum.INGREDIENT_EFFECTIVENESS, null, "sum", false),

    SUM_TOTAL_HEALTH("", "total_health", "total_health", "", "sum", SumEnum.TOTAL_HEALTH, null, "sum", false),
    SUM_TOTAL_HP_REGEN("", "total_hp_regen", "total_hp_regen", "", "sum", SumEnum.TOTAL_HEALTH_REGEN, null, "sum", false),
    SUM_RAW_DEFENSES("", "raw_defenses", null, "", "sum", SumEnum.RAW_DEFENSES, null, null, false),
    SUM_RAW_RAINBOW_DEFENSES("", "raw_rainbow_defense", null, "", "sum", SumEnum.RAW_RAINBOW_DEFENSES, null, null, false),
    SUM_DEFENSES_PERCENT("", "defenses", "defenses", "", "sum", SumEnum.DEFENSES_PERCENT, null, "sum", false),
    SUM_RAINBOW_DEFENSES_PERCENT("", "rainbow_defense", "rainbow_defense", "", "sum", SumEnum.RAINBOW_DEFENSES_PERCENT, null, "sum", false),
    SUM_SKILL_POINT_BONUS("", "sp_bonus", "sp_bonus", "", "sum", SumEnum.SKILL_POINT_BONUS, null, "sum", false),
    SUM_RAINBOW_SKILL_POINT_BONUS("", "rainbow_sp_bonus", "rainbow_sp_bonus", "", "sum", SumEnum.RAINBOW_SKILL_POINT_BONUS, null, "sum", false),

    SUM_BASE_DPS("", "base_dps", null, "", "sum", SumEnum.BASE_DPS, null, null, false),
    SUM_NEUTRAL_DPS("", "neutral_dps", null, "", "sum", SumEnum.NEUTRAL_DPS, null, null, false),
    SUM_EARTH_DPS("", "earth_dps", null, "", "sum", SumEnum.EARTH_DPS, null, null, false),
    SUM_THUNDER_DPS("", "thunder_dps", null, "", "sum", SumEnum.THUNDER_DPS, null, null, false),
    SUM_WATER_DPS("", "water_dps", null, "", "sum", SumEnum.WATER_DPS, null, null, false),
    SUM_FIRE_DPS("", "fire_dps", null, "", "sum", SumEnum.FIRE_DPS, null, null, false),
    SUM_AIR_DPS("", "air_dps", null, "", "sum", SumEnum.AIR_DPS, null, null, false),

    SUM_RAW_DAMAGES("", "raw_damages", null, "", "sum", SumEnum.RAW_DAMAGES, null, null, false),
    SUM_RAW_RAINBOW_DAMAGES("", "raw_rainbow_damage", null, "", "sum", SumEnum.RAW_RAINBOW_DAMAGES, null, null, false),
    SUM_DAMAGES_PERCENT("", "damages", "damages", "", "sum", SumEnum.DAMAGES_PERCENT, null, "sum", false),
    SUM_RAINBOW_DAMAGES_PERCENT("", "rainbow_damage", "rainbow_damage", "", "sum", SumEnum.RAINBOW_DAMAGES_PERCENT, null, "sum", false),

    SUM_TOTAL_MELEE_DAMAGE("", "total_melee_damage", null, "", "sum", SumEnum.TOTAL_MELEE_DAMAGE, null, null, false),
    SUM_TOTAL_NEUTRAL_MELEE_DAMAGE("", "total_neutral_melee_damage", null, "", "sum", SumEnum.TOTAL_NEUTRAL_MELEE_DAMAGE, null, null, false),
    SUM_TOTAL_EARTH_MELEE_DAMAGE("", "total_earth_damage", null, "", "sum", SumEnum.TOTAL_EARTH_MELEE_DAMAGE, null, null, false),
    SUM_TOTAL_THUNDER_MELEE_DAMAGE("", "total_thunder_damage", null, "", "sum", SumEnum.TOTAL_THUNDER_MELEE_DAMAGE, null, null, false),
    SUM_TOTAL_WATER_MELEE_DAMAGE("", "total_water_damage", null, "", "sum", SumEnum.TOTAL_WATER_MELEE_DAMAGE, null, null, false),
    SUM_TOTAL_FIRE_MELEE_DAMAGE("", "total_fire_damage", null, "", "sum", SumEnum.TOTAL_FIRE_MELEE_DAMAGE, null, null, false),
    SUM_TOTAL_AIR_MELEE_DAMAGE("", "total_air_damage", null, "", "sum", SumEnum.TOTAL_AIR_MELEE_DAMAGE, null, null, false),

    SUM_TOTAL_MELEE_DPS("", "total_melee_dps", null, "", "sum", SumEnum.TOTAL_MELEE_DPS, null, null, false),
    SUM_TOTAL_SPELL_DPS("", "total_spell_dps", null, "", "sum", SumEnum.TOTAL_SPELL_DPS, null, null, false),
    SUM_TOTAL_NEUTRAL_MELEE_DPS("", "total_neutral_melee_dps", null, "", "sum", SumEnum.TOTAL_NEUTRAL_MELEE_DPS, null, null, false),
    SUM_TOTAL_NEUTRAL_SPELL_DPS("", "total_neutral_spell_dps", null, "", "sum", SumEnum.TOTAL_NEUTRAL_SPELL_DPS, null, null, false),
    SUM_TOTAL_EARTH_MELEE_DPS("", "total_earth_melee_dps", null, "", "sum", SumEnum.TOTAL_EARTH_MELEE_DPS, null, null, false),
    SUM_TOTAL_EARTH_SPELL_DPS("", "total_earth_spell_dps", null, "", "sum", SumEnum.TOTAL_EARTH_SPELL_DPS, null, null, false),
    SUM_TOTAL_THUNDER_MELEE_DPS("", "total_thunder_melee_dps", null, "", "sum", SumEnum.TOTAL_THUNDER_MELEE_DPS, null, null, false),
    SUM_TOTAL_THUNDER_SPELL_DPS("", "total_thunder_spell_dps", null, "", "sum", SumEnum.TOTAL_THUNDER_SPELL_DPS, null, null, false),
    SUM_TOTAL_WATER_MELEE_DPS("", "total_water_melee_dps", null, "", "sum", SumEnum.TOTAL_WATER_MELEE_DPS, null, null, false),
    SUM_TOTAL_WATER_SPELL_DPS("", "total_water_spell_dps", null, "", "sum", SumEnum.TOTAL_WATER_SPELL_DPS, null, null, false),
    SUM_TOTAL_FIRE_MELEE_DPS("", "total_fire_melee_dps", null, "", "sum", SumEnum.TOTAL_FIRE_MELEE_DPS, null, null, false),
    SUM_TOTAL_FIRE_SPELL_DPS("", "total_fire_spell_dps", null, "", "sum", SumEnum.TOTAL_FIRE_SPELL_DPS, null, null, false),
    SUM_TOTAL_AIR_MELEE_DPS("", "total_air_melee_dps", null, "", "sum", SumEnum.TOTAL_AIR_MELEE_DPS, null, null, false),
    SUM_TOTAL_AIR_SPELL_DPS("", "total_air_spell_dps", null, "", "sum", SumEnum.TOTAL_AIR_SPELL_DPS, null, null, false),

    SUM_RAW_SPELL_COSTS("", "raw_spell_costs", null, "", "sum", SumEnum.RAW_SPELL_COSTS, null, null, false),
    SUM_SPELL_COSTS_PERCENT("", "spell_costs", null, "", "sum", SumEnum.SPELL_COSTS_PERCENT, null, null, false)
    ;
