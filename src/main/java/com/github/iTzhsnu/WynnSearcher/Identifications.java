...
public enum Identifications {
    ...
    SUM_TOTAL_EARTH_DAMAGE("total_earth_damage", null, false, "sum", SumEnum.TOTAL_EARTH_DAMAGE, null, false),
    SUM_TOTAL_THUNDER_DAMAGE("total_thunder_damage", null, false, "sum", SumEnum.TOTAL_THUNDER_DAMAGE, null, false),
    SUM_TOTAL_WATER_DAMAGE("total_water_damage", null, false, "sum", SumEnum.TOTAL_WATER_DAMAGE, null, false),
    SUM_TOTAL_FIRE_DAMAGE("total_fire_damage", null, false, "sum", SumEnum.TOTAL_FIRE_DAMAGE, null, false),
    SUM_TOTAL_AIR_DAMAGE("total_air_damage", null, false, "sum", SumEnum.TOTAL_AIR_DAMAGE, null, false),

    SUM_TOTAL_DPS("total_dps", null, false, "sum", SumEnum.TOTAL_DPS, null, false),
    ...
    SUM_TOTAL_EARTH_DPS("total_earth_dps", null, false, "sum", SumEnum.TOTAL_EARTH_DPS, null, false),
    SUM_TOTAL_THUNDER_DPS( "total_thunder_dps", null, false, "sum", SumEnum.TOTAL_THUNDER_DPS, null, false),
    SUM_TOTAL_WATER_DPS( "total_water_dps", null, false, "sum", SumEnum.TOTAL_WATER_DPS, null, false),
    SUM_TOTAL_FIRE_DPS("total_defense_dps", null, false, "sum", SumEnum.TOTAL_FIRE_DPS, null, false),
    SUM_TOTAL_AIR_DPS("total_air_dps", null, false, "sum", SumEnum.TOTAL_AIR_DPS, null, false),
