...
public enum Identifications {
    ...
    QUEST_REQ("Quest Req", "quest", null, false, "string", null, null),
    ...
    RAW_EARTH_SPELL_DAMAGE("Earth Spell Damage", null, null, false, "int", null, null),
    ...
    INGREDIENT_EFFECTIVENESS(null, null, "ingEffective", true, "sum", SumEnum.INGREDIENT_EFFECTIVENESS, null),
    ...
    SUM_TOTAL_HEALTH(null, "total_health", "total_health", false, "sum", SumEnum.TOTAL_HEALTH, null),
    ...
    SUM_DEFENSES_PERCENT(null, "defenses", "defenses", true, "sum", SumEnum.DEFENSES_PERCENT, null),
    SUM_RAINBOW_DEFENSES_PERCENT(null, "rainbow_defense", "rainbow_defense", true, "sum", SumEnum.RAINBOW_DEFENSES_PERCENT, null),
    SUM_SKILL_POINT_BONUS(null, "sp_bonus", "sp_bonus", false, "sum", SumEnum.SKILL_POINT_BONUS, null),
    SUM_RAINBOW_SKILL_POINT_BONUS(null, "rainbow_sp_bonus", "rainbow_sp_bonus", false, "sum", SumEnum.RAINBOW_SKILL_POINT_BONUS, null),
    ...
    SUM_DAMAGES_PERCENT(null, "damages", "damages", true, "sum", SumEnum.DAMAGES_PERCENT, null),
    SUM_RAINBOW_DAMAGES_PERCENT(null, "rainbow_damage", "rainbow_damage", true, "sum", SumEnum.RAINBOW_DAMAGES_PERCENT, null),
