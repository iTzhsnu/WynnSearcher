...
public enum Identifications {
    ...
    RARITY("Rarity", "rarity", "tier", "", "string", null, "nothing", "nothing", false),

    HEALTH("Health", "baseHealth", null, "", "int", null, "base", null, false),
    ...
    EARTH_DEFENSE("Earth Defense", "baseEarthDefence", null, "", "int", null, "base", null, false),
    THUNDER_DEFENSE("Thunder Defense", "baseThunderDefence", null, "", "int", null, "base", null, false),
    WATER_DEFENSE("Water Defense", "baseWaterDefence", null, "", "int", null, "base", null, false),
    FIRE_DEFENSE("Fire Defense", "baseFireDefence", null, "", "int", null, "base", null, false),
    AIR_DEFENSE("Air Defense", "baseAirDefence", null, "", "int", null, "base", null, false),
    ...
    ELEMENTAL_DEFENSE_PERCENT("Elemental Defense", "elementalDefence", "elementalDefence", "%", "int", null, "identifications", "identifications", true),

    NEUTRAL_DAMAGE("Neutral Damage", "baseDamage", null, "", "int", null, "base", null, true),
    EARTH_DAMAGE("Earth Damage", "baseEarthDamage", null, "", "int", null, "base", null, true),
    THUNDER_DAMAGE("Thunder Damage", "baseThunderDamage", null, "", "int", null, "base", null, true),
    WATER_DAMAGE("Water Damage", "baseWaterDamage", null, "", "int", null, "base", null, true),
    FIRE_DAMAGE("Fire Damage", "baseFireDamage", null, "", "int", null, "base", null, true),
    AIR_DAMAGE("Air Damage", "baseAirDamage", null, "", "int", null, "base", null, true),

    DAMAGE_PERCENT("Damage", "damage", "damage", "%", "int", null, "identifications", "identifications", true),
    NEUTRAL_DAMAGE_PERCENT("Neutral Damage", "neutralDamage", "neutralDamage", "%", "int", null, "identifications", "identifications", true),
    ...
    CRITICAL_DAMAGE_PERCENT("Critical Damage", "criticalDamageBonus", "criticalDamageBonus", "%", "int", null, "identifications", "identifications", true),
    ...
    RAW_DAMAGE("Raw Damage", "rawDamage", "rawDamage", "", "int", null, "identifications", "identifications", true),
    ...
    DAMAGE_FROM_MOBS("Damage From Mobs", "damageFromMobs", null, "%", "int", null, "base", null, false),
    LEVELED_LOOT_BONUS("Leveled Loot Bonus", "leveledLootBonus", null, "%", "int", null, "base", null, false),
    LEVELED_XP_BONUS("Leveled XP Bonus", "leveledXpBonus", null, "%", "int", null, "base", null, false),
    ...
    DROP_TYPE_WORLD_EVENT("world_event", "dropRestriction", "droppedBy", "", "string", null, "nothing", "nothing", false),
    DROP_TYPE_LOOTRUN("lootrun", "dropRestriction", "droppedBy", "", "string", null, "nothing", "nothing", false),
