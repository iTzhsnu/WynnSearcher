...
public enum SpellEnum {
    ...
    NIMBLE_STRING(-10, 0, 0, 0, 0, 0, 6), //ADD (Arrow Storm)
    WINDSTORM(-10, 0, -2, 0, 0, 2, 2), //ADD (Arrow Storm) (2 Stream)
    ARROW_HURRICANE(-3, 0, -4, 0, 0, 2, 0), //ADD (Arrow Storm) (3 Stream)
    ...
    SHOCKING_BOMB(0, 0, 40, 0, 0, 0, 0), //ADD (Arrow Bomb)
    ...
    ARROW_BOMB_SELF_DAMAGE(25, 0, 0, 0, 0, 0, 1), //BASE (Arrow Bomb)
    SHRAPNEL_BOMB(40, 0, 0, 0, 20, 0, 15), //BASE (Arrow Bomb)

    //Arrow Shield
    ARROW_SHIELD(90, 0, 0, 0, 0, 10, 2), //BASE
    MORE_SHIELDS_ARROW_SHIELD(0, 0, 0, 0, 0, 0, 2), //ADD (Arrow Shield)
    ...
    BASALTIC_TRAP(190, 30, 0, 0, 30, 0, 1), //BASE (Arrow Bomb)
    ...
    //Teleport
    WIND_SLASH(50, 0, 0, 0, 0, 50, 1), //BASE (Teleport)
    EXPLOSIVE_ENTRANCE(50, 0, 0, 0, 30, 0, 1), //BASE (Teleport)
    TRANSONIC_WARP(10, 0, 3, 0, 0, 3, 1), //BASE (Teleport) (per Winded)

    //Meteor
    METEOR(300, 100, 0, 0, 0, 0, 1), //BASE
    STRONGER_METEOR(30, 90, 0, 0, 0, 0, 0), //ADD (Meteor)
    BREATHLESS_METEOR(21, 9, 0, 0, 0, 0, 0), //ADD (Meteor) (per Winded)
    THUNDERSTORM(30, 0, 15, 0, 0, 0, 3), //BASE (Meteor)
    BREATHLESS_THUNDERSTORM(7, 3, 0, 0, 0, 0, 1), //ADD (Thunderstorm) (per Winded)

    OPHANIM(60, 0, 30, 30, 0, 0, 1), //BASE CHANGE (Meteor)
    ...
    //Other
    BURNING_SIGIL(15, 0, 0, 0, 25, 0, 12), //BASE (Meteor) (per 0.4s)
    PSYCHOKINESIS(150, 0, 0, 0, 0, 0, 1), //BASE (Melee) (Melee Damage)
